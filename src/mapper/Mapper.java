...
/**
 * La classe {@code Mapper} Ã¨ utilizzata per mappare oggetti di tipo {@link Utente}, {@link Ristorante} e {@link Recensione}
...
public class Mapper {
	...
	public static Ristorante mapObjRistorante(String linea) {
	    ...
	    // valori[7] = prezzo
	    // valori[8] = disponibilitÃ _delivery
	    // valori[9] = disponibilitÃ _prenotazione
	...
	public static String mapStrRistorante(Ristorante r) {
	    ...
	    return r.getNome() + "," 
	         ...
	         + r.getLongitudine() + "," 
	         + r.getPrezzo() + "," 
	         + r.isDisponibilitÃ _delivery() + "," 
	         + r.isDisponibilitÃ _prenotazione() + "," 
	         + r.getTipo_Cucina();
	}
