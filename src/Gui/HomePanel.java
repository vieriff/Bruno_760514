...
/**
 * Pannello che permette la scelta del tipo di ricerca di ristoranti.
 * L'utente può scegliere di cercare per zona o per nome.
 */
public class CercaRistorantiPanel extends JPanel {
    ...
    /**
     * Costruttore del pannello CercaRistorantiPanel.
     * 
     * @param frame riferimento al MainFrame per la navigazione tra i pannelli
     * @param pannelloChiamante nome del pannello chiamante (per contesto)
     */
