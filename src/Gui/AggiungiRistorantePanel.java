...
/**
 * Pannello per l'aggiunta di un nuovo ristorante.
 * Permette di inserire i dati richiesti tramite un form grafico.
 */
public class AggiungiRistorantePanel extends JPanel {
    /**
     * Costruttore che crea e configura il pannello con il form per l'inserimento
     * dei dati del ristorante e i pulsanti di conferma e ritorno.
     * 
     * @param frame Riferimento al frame principale per la gestione della navigazione.
     */
    public AggiungiRistorantePanel(MainFrame frame) {
        ...
        JTextField cittÃ  = new JTextField();
        ...
        form.add(new JLabel("Fascia di prezzo (â‚¬):"));
        form.add(prezzo);
        ...
        conferma.addActionListener(e -> {
            try {
                ...
                String city = cittÃ .getText().trim();
